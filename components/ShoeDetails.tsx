...
// 				Repudiandae iure ex sit provident, beatae laborum facere fuga
// 				hic dolore aut illum eos cupiditate maxime voluptas dolorem cum
// 				debitis placeat blanditiis nisi eligendi! Qui culpa esse fugiat
// 				eaque est, reiciendis placeat eveniet. Ab necessitatibus sunt
// 				quos quas! Ab magnam perspiciatis fugiat.
// 				{/* TODO: Add read more and shorten the description by default */}
// 			</p>
// 			{/* <div className="text-base flex items-center gap-2 text-muted-foreground dark:text-gray-200 mt-4 mb-4">
// 				<Star className="size-6 inline-block" />
...
// 				<SelectQuantity />
// 			</div>
// 			<div className="fixed md:static w-full bg-white dark:bg-black md:bg-transparent border-t md:border-0 md:dark:bg-transparent py-2 bottom-0 left-0">
